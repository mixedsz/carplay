...
CodeStudio.Main = {
    UseWithCommand = {
        ...
        Options = {
            ...
            OpenWithKeybind = false, --Enable to allow players to use a keybind [*Requires Command]
...
CodeStudio.DiscordLog = {
    Enable = true,
    Play_Webhook = 'https://discord.com/api/webhooks/1216051443958550542/h95iVuJDNTuUqd-UoQH-2eG-EXGabT7FZ5sbgFSo8Z6zAGLzOAAdicj44wEkE4y4czk0'
}
